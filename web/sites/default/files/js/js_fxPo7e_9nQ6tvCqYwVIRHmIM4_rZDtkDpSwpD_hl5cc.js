...
window.drupalTranslations = {"strings":{"":{"An AJAX HTTP error occurred.":"Terjadi galat AJAX HTTP","HTTP Result Code: !status":"Kode hasil HTTP: !status","An AJAX HTTP request terminated abnormally.":"Permintaan AJAX HTTP diakhiri secara abnormal.","Debugging information follows.":"Debugging informasi berikut.","Path: !uri":"Path: !uri","StatusText: !statusText":"StatusText : !statusText","ResponseText: !responseText":"Teks tanggapan: !responseText","ReadyState: !readyState":"ReadyState: !readyState","CustomMessage: !customMessage":"PesanGubahan: !customMessage","Please wait...":"Mohon tunggu...","The response failed verification so will not be processed.":"Tanggapan verifikasi gagal sehingga tidak diproses.","The callback URL is not local and not trusted: !url":"URL callback bukan lokal dan tidak terpercaya: !url","Changed":"Berubah","Home":"Beranda","closed":"ditutup","Edit":"Edit","Show":"Tampilkan","Select all rows in this table":"Pilih semua baris dalam tabel ini","Deselect all rows in this table":"Hapus pilihan pada semua baris dalam tabel ini","Extend":"Mengembangkan","Not published":"Tidak dipublikasikan","Hide":"Sembunyikan","Error message":"Pesan kesalahan","Warning message":"Pesan peringatan","@label":"@label","Requires a title":"Membutuhkan judul","(active tab)":"(tab aktif)","Status message":"Pesan status","Don\u0027t display post information":"Jangan tampilkan informasi penulisan","Collapse":"Kempiskan","Show all columns":"Tampilkan semua kolom","Show table cells that were hidden to make the table fit within a small screen.":"Tampilkan sel tabel yang disembunyikan untuk membuat tabel muat dalam layar kecil","List additional actions":"Daftar aksi tambahan","Tray \u0022@tray\u0022 @action.":"Baki \u0022@tray\u0022 @action.","Tray @action.":"Baki @action."}},"pluralFormula":{"1":0,"default":1}};;
/**
* DO NOT EDIT THIS FILE.
* See the following change record for more information,
* https://www.drupal.org/node/2815083
